...
class DICOMViewer:
    ...
    def create_image_window(self):
        ...
        #place widjet
        self.toggle_drag_button.pack(side=tk.LEFT, padx=5, pady=5,anchor="nw")
        next_button.pack(side=tk.LEFT, padx=5, pady=5,anchor="nw")
        prev_button.pack(side=tk.LEFT, padx=5, pady=5,anchor="nw")
        zoom_in_button.pack(side=tk.LEFT, padx=5, pady=5,anchor="nw")
        zoom_out_button.pack(side=tk.LEFT, padx=5, pady=5,anchor="nw")
        straight_line_button.pack(side=tk.LEFT, padx=5, pady=5,anchor="nw")
        dashed_line_button.pack(side=tk.LEFT, padx=5, pady=5,anchor="nw")
        single_arrow_button.pack(side=tk.LEFT, padx=5, pady=5,anchor="nw")
        self.rotate_flip_button.pack(side=tk.LEFT, padx=5, pady=5,anchor="nw")
        self.canvas_widget.pack(side=tk.BOTTOM, expand=True, padx=10, pady=10,anchor="sw",before=self.toggle_drag_button,fill="both")
