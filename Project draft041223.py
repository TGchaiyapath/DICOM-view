...
class DICOMViewer:
    ...
    def create_image_window(self):
        ...
        Hflip_icon_path = os.path.abspath(r"C:\Users\Admin\Desktop\TG\TEST\icon\flip.png")  
        ...
        flip_horizontal_button.place(x=340,y=0)

        # Load a vertical flip icon image
        Vflip_icon_path = os.path.abspath(r"C:\Users\Admin\Desktop\TG\TEST\icon\vertical-flip.png")  
        ...
        flip_vertical_button.place(x=370,y=0)
       
        # Load a rotate right icon image
        RotateR_icon_path = os.path.abspath(r"C:\Users\Admin\Desktop\TG\TEST\icon\rotate-right.png")  
        ...
        rotate_button_clockwise.place(x=400,y=0)

        # Load a rotate right icon image
        RotateL_icon_path = os.path.abspath(r"C:\Users\Admin\Desktop\TG\TEST\icon\rotate-left.png")  
        ...
        rotate_button_counterclockwise.place(x=430,y=0)
        # Button to open the menu
        menu_button = tk.Button(image_window, text="Open Menu", command=self.open_menu)
        menu_button.place(x=460, y=0)

        # Menu
        self.menu = Menu(image_window, tearoff=0)
        self.menu.add_command(label="Item 1", command=self.menu_item1)
        self.menu.add_command(label="Item 2", command=self.menu_item2)
        self.menu.add_command(label="Item 3", command=self.menu_item3)
    ...
    def open_menu(self):
        # Display the menu at the specified coordinates
            self.menu.post(460, 30)

    def menu_item1(self):
        # Define the action for Menu Item 1
        print("Menu Item 1 clicked!")

    def menu_item2(self):
        # Define the action for Menu Item 2
        print("Menu Item 2 clicked!")

    def menu_item3(self):
        # Define the action for Menu Item 3
        print("Menu Item 3 clicked!")
